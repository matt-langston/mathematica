...
*)
BeginPackage["WWDC`WWDC2014SessionVideoLibrary`",
	{
		"WWDC`WWDC2014`",
		"Utilities`TextFile`"
	}
...
sessionVideoDownloadUrl::usage               = "";
sessionVideoDownloadPrefix::usage            = "";
sessionVideoDownloadUrlToken::usage          = "";
sessionVideoDownloadUrlSessionID1::usage     = "";
sessionVideoDownloadUrlFileName::usage       = "";
sessionVideoDownloadUrlSessionID2::usage     = "";
sessionVideoDownloadUrlDownloadFormat::usage = "";
sessionVideoDownloadUrlVideoRest::usage      = "";
...
*)
DefaultSessionVideoDownloadUrlPrefix = "http://devstreaming.apple.com/videos/wwdc/2014/";
Options[SessionVideoHyperlinkPattern] = {SessionVideoDownloadUrlPrefix -> DefaultSessionVideoDownloadUrlPrefix};
...
sessionVideoDownloadUrl               = http://devstreaming.apple.com/videos/wwdc/2014/403xxksrj0qs8c0/403/403_hd_intermediate_swift.mov?dl=1
sessionVideoDownloadPrefix            = http://devstreaming.apple.com/videos/wwdc/2014/
sessionVideoDownloadUrlToken          = 403xxksrj0qs8c0
sessionVideoDownloadUrlSessionID1     = 403
sessionVideoDownloadUrlFileName       = 403_hd_intermediate_swift.mov
sessionVideoDownloadUrlSessionID2     = 403
sessionVideoDownloadUrlDownloadFormat = hd
sessionVideoDownloadUrlVideoRest      = ?dl=1_swift
*)
...
~~ "/" ~~ sessionVideoDownloadUrlFileName:(sessionVideoDownloadUrlSessionID2:DigitCharacter..
  ~~ ("_" ~~ sessionVideoDownloadUrlDownloadFormat:("hd" | "sd") ~~ __ ~~ ".mov") | (__ ~~ ".pdf"))
...
Module[{textFile, lines, sessionVideoDownloadUrlRawData, sessionVideoDownloadUrlDataList, sessionVideoLibraryDataList, titleAndTrackList, sessionIDList, titleAndTrackAndSessionIDList},
	...
	If[
		...
		sessionVideoDownloadUrlDataList = Flatten[StringCases[sessionVideoDownloadUrlRawData, SessionVideoHyperlinkPattern[] :>
			SessionVideoDownloadUrlData[
				...
				If[StringLength[sessionVideoDownloadUrlDownloadFormat] > 0, ToUpperCase[sessionVideoDownloadUrlDownloadFormat], "PDF"],
				sessionVideoDownloadUrlFileName,
		...
		#[[2]] == SessionTrack
		*)
		titleAndTrackList             =             sessionVideoLibraryDataList[[2, 3, All, 1, ;; 2]];
		sessionIDList                 = StringCases[sessionVideoLibraryDataList[[2, 3, All, 2, 2   ]], "Session" ~~ Whitespace ~~ sessionID:DigitCharacter.. :> sessionID];
		titleAndTrackAndSessionIDList = Map[Flatten, Transpose[{titleAndTrackList, sessionIDList}]];
		lines = Map[SessionVideoData[ToExpression[#[[3]]], #[[1]], #[[2]], Cases[sessionVideoDownloadUrlDataList, SessionVideoDownloadUrlData[___, SessionVideoDownloadUrlSessionID1 -> ToExpression[#[[3]]], ___]], textFile]&, titleAndTrackAndSessionIDList];
